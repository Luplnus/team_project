...
public class PaymentTheaterDto { // 시퀀스넘버로 정보 받기
    ...
    public PaymentTheaterDto() {
    }

    public PaymentTheaterDto(int p_seqno, int b_seqno, int u_seqno, int pm_seqno, int p_price, Date p_date) {
