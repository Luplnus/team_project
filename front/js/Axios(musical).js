...
document.addEventListener("DOMContentLoaded", function () {
    axios.get("http://localhost:8080/api/musicals").then(function (response) {
...
bookBtn.addEventListener('click', function (e) {
    e.preventDefault();
    window.location.href = "/ticketing_page.html?type=musical&content_id=" + code; // 로그인은 결제페이지로 넘어갈 때 판단
})
