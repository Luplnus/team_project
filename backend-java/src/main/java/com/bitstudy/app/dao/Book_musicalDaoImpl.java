...
@Repository
public class Book_musicalDaoImpl implements Book_musicalDao {

    @Autowired
    private SqlSession session;

    private String namespace = "com.bitstudy.app.dao.Book_musicalMapper.";
    ...
    public int insert(Book_musicalDto book_musicalDto) {
        return session.insert(namespace+"insert", book_musicalDto);
    }
