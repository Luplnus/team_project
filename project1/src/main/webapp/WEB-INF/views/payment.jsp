        ...
        <div class="pay_tool">
            ...
            <div class="ticket_info">
                <div class="post_banner">
                    <img src="${sessionScope.movieDto.m_poster_url}${sessionScope.musicalDto.mu_poster}${sessionScope.theaterDto.t_poster}" alt="관련 포스터" class="bn_img">
                </div>

                <div class="tck_text">
                    <h2 id="tck_title">${sessionScope.movieDto.m_title}${sessionScope.musicalDto.m_title}${sessionScope.theaterDto.t_title}</h2>
                    <p class="tck_p" id="tck_count">${sessionScope.venue}</p>
                    <p class="tck_p" id="tck_seat">${sessionScope.s_label}</p>
                    <p class="tck_p" id="tck_date">${sessionScope.time}</p>
                </div>
            </div>
