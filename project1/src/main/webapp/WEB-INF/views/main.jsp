...
<header>
  <div id="wrap">
    ...
    <div class="main_menu">
      <div class="h_menubox">
        <div class="main_logo">
          <h2><a href="<c:url value="/" />" style="color: inherit; text-decoration: none" >JPIEL</a></h2>
        </div>
        <div class="menu_bar">
          ...
          <a href="<c:url value="/ticketing_page.html" />" style="text-decoration: none"><div class="menu_box">예매</div></a>
        </div>
        <div class="content" style="width: 120px">
          <div class="content_box">
              <img src="<c:url value="/img/search.svg"/>" alt="">
          </div>
          <c:choose>
            <c:when test="${logInTxt == 'notDone'}">
              <div class="content_box content_box_login" style="width: 50px">
                <a href="<c:url value='/Loginpage.html' />" >
                  로그인
                </a>
              </div>
            </c:when>
            <c:otherwise>
              <div class="content_box content_box_myPageIcon">
                <img src="<c:url value="/img/user.svg"/>" alt="">
