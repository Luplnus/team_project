...
document.addEventListener("DOMContentLoaded", function () {
    axios.get("http://localhost:8080/app/api/musicals").then(function (response) {
...
searchBar.addEventListener('keydown', function (e) {
    if (e.key == 'Enter') {
        ...
        if (searchValue) {
            axios.get("http://localhost:8080/app/api/search_musical", {
...
bookBtn.addEventListener('click', function (e) {
    e.preventDefault();
    axios.get("http://localhost:8080/app/api/loginChk")
        .then(function (response) {
